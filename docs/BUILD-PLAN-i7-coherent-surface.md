...
**Iteration slug:** `i7-coherent-surface` · **Status:** Approved (Keith, 2026-05-31 — cleared for build launch; D1 locked to the new `intro_advance` event; D2–D14 build to the recommended resolutions in the table) · **Date:** 2026-05-31 · **Planner:** kmaz-plan-iteration
